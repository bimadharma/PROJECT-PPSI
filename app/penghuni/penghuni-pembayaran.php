                  ...
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="font-weight-bold text-success">Lakukan pembayaran kamar offline (Melalui Teknisi Kost, dengan meminta struk pembayaran) atau transfer ke <br><br>(Rekening no. 123456 [MANDIRI] A.N. Luqman) <br><br> Foto/Scan Bukti pembayaran dan upload saat melakukan pembayaran</td>
                      </tr>                                            
                    </tbody>
                  </table>
